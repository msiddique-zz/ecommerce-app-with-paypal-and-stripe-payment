...
import { getCategories, getProduct } from './apiAdmin'
...
const UpdateProduct = (props) => {
    ...
    const init = (productId) => {
        ...
        getProduct(productId).then(data => {
            if (data.error) {
                ...
                console.log('------------------------categories ka error------------', data)
                setValues({
                    ...values,
                    name: data.name,
    ...
    const clickSubmit = event => {
        ...
        updateProduct(user._id, props.match.params.productId, token, formData).then(data => {
            if (data.error) {
                setValues({ ...values, error: data.error });
            } else {
                setValues({
